...
class DistinctSubsequencesTest {
    ...
    void givenSmallMatching_whenNumDistinct_thenReturn3() {
        ...
        assertEquals(3, new DistinctSubsequences().numDistinctBottomUp(s,t));
    }

    @Test
    void givenRepeatingPattern_whenNumDistinct_thenReturn5() {
        String s = "babgbag", t = "bag";
        assertEquals(5, new DistinctSubsequences().numDistinctBottomUp(s,t));
    }
    ...
    void givenLongInput_whenNumDistinct_thenReturnInTime() {
        ...
        assertTimeout(Duration.ofMillis(500), () -> new DistinctSubsequences().numDistinctBottomUp(s,t));
    }
}